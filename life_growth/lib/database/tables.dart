...
enum GoalCategory { personal, professional, health, education, financial, relationships, hobbies, other }
...
class Goals extends Table {
  ...
  TextColumn get priority => text().map(const GoalPriorityConverter()).withDefault(const Constant('medium'))();
  DateTimeColumn get targetDate => dateTime()();
  BoolColumn get isCompleted => boolean().withDefault(const Constant(false))();
  DateTimeColumn get completedAt => dateTime().nullable()();
  IntColumn get progress => integer().withDefault(const Constant(0))(); // 0-100 percentage
  DateTimeColumn get createdAt => dateTime().withDefault(currentDateAndTime)();
  DateTimeColumn get updatedAt => dateTime().withDefault(currentDateAndTime)();
  BoolColumn get needsSync => boolean().withDefault(const Constant(true))();
  DateTimeColumn get lastSyncAt => dateTime().nullable()();
...
class JournalEntries extends Table {
  ...
  IntColumn get mood => integer().withDefault(const Constant(5))(); // 1-10 scale
